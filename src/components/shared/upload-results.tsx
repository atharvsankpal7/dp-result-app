...
const singleResultSchema = z.object({
  ...
  annual_theory: z.coerce.number().min(0).max(70, "Annual theory marks must be between 0 and 80"),
  annual_practical: z.coerce.number().min(0).max(30, "Annual practical marks must be between 0 and 50"),
}).refine((data) => data.annual_theory + data.annual_practical <= 100, {
  message: "Total marks for annual theory and practical must be between 0 and 100",
