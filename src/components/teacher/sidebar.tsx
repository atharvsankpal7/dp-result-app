...
const Sidebar = () => {
  ...
  const navigation = [
    { name: "Upload Results", href: "/teacher/dashboard/upload-results", icon: FileText },
    { name: "View Results", href: "/teacher/dashboard/view-results", icon: FileText },
  ];
    ...
    <>
      ...
      >
        <div className="relative flex flex-col w-64 h-full bg-white border-r border-gray-200 pt-16">
          <div className="px-4 py-4 font-bold text-xl">Teacher Dashboard</div>
